...
class UserModelTestCase(TestCase):
    ...
    def test_user_signup(self):
        ...
        self.assertEqual(len(db.session.query(User.id).all()), 3)
        self.assertEqual(user.username, "test3")
        self.assertEqual(user.email, "email3@gmail.com")
...
#import exc from sqlachemy
#just test for None
#assertRaises
#ValueError vs exc.IntegrityError how do i remember